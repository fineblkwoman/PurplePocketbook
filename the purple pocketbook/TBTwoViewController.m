...
@property (nonatomic, strong) PPAppDelegate *appDelegate;
...
- (void)viewDidLoad
{
    ...
    _appDelegate = (PPAppDelegate *)[[UIApplication sharedApplication] delegate];
...
-(void)actionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex{
    if (buttonIndex != [[_appDelegate.mcManager.session connectedPeers] count]) {
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            NSProgress *progress = [_appDelegate.mcManager.session sendResourceAtURL:resourceURL withName:modifiedName
